...
* **CSS3:** For all styling, including a responsive layout and custom properties.
* **JavaScript (ES6+):** For all interactivity, including page navigation and form handling.
